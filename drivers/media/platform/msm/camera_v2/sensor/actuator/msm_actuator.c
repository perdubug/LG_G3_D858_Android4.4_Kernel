...
{
	int rc = 0;
    /* LGE_CHAGNE_S, Redece tick-noise G3_non-OIS Model, 2014-05-22, seongjo.kim@lge.com */
    struct msm_camera_i2c_reg_setting reg_setting;
    /* LGE_CHAGNE_E, Redece tick-noise G3_non-OIS Model, 2014-05-22, seongjo.kim@lge.com */
...
static int32_t msm_actuator_StablePosition(struct msm_actuator_ctrl_t *a_ctrl)
{
	...
	if (a_ctrl->curr_step_pos != 0)
	{
      ...
      if (a_ctrl->step_position_table == NULL)
		...
		for(i = 0; i < 12; i++) { /* LGE_CHAGNE, Redece tick-noise G3_non-OIS Model, 2014-05-22, seongjo.kim@lge.com */
